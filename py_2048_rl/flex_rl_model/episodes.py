...
class EdpisodeDB():
  def __init__(self, mem_size, input_dims, **kwargs):
    ...
    self.states_mem = tf2.Variable(tf2.constant(0., shape=states_dims, dtype=tf2.float32))
  ...
  def store_episode(self, e, **kwargs):
    ...
    self.states_mem.scatter_nd_update(ind_arr, tf2.constant(e.state, dtype=tf2.float32))
